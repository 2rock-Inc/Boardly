...
public final class ProfileStore {
    ...
    public func addProfile(_ profile: ServerProfile) {
        BoardlyLog.tag(.profile).info("Profile added", metadata: ["name": profile.name])
    ...
    public func removeProfile(id: UUID) {
        BoardlyLog.tag(.profile).info("Profile removed", metadata: ["id": id.uuidString])
    ...
    public func setActiveProfile(id: UUID) {
        ...
        BoardlyLog.tag(.profile).info("Active profile set", metadata: ["id": id.uuidString])
        activeProfileID = id
